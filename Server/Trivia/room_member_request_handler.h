...
{
public:
	RoomMemberRequestHandler(const Room& room, const LoggedUser& user, std::shared_ptr<RoomManager> roomManager, std::shared_ptr<RequestHandlerFactory> handlerFactory);
